...
def initialize_openai_model(api_key):
    ...
    return ChatOpenAI(temperature=0.5, model_name="gpt-3.5-turbo-0125")
...
def define_prompt_template():
    ...
    return ChatPromptTemplate.from_messages([
        ("user", """You are a social media script writer. 
                    ...
                    Generate appropriate title as well for the generated content.
...
def main():
    ...
    st.write("This app generates scripts for social media content using OpenAI's gpt-3.5-turbo-0125 model.")
